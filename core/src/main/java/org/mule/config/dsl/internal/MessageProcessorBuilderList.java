 ...
 * @author porcelli
 */
public interface MessageProcessorBuilderList extends org.mule.config.dsl.DSLBuilder {
     ...
     */
    void addBuilder(DSLBuilder<? extends MessageProcessor> builder) throws NullPointerException;
     ...
     */
    List<DSLBuilder<? extends MessageProcessor>> getBuilders();
