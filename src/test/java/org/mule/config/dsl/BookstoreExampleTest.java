...
public class BookstoreExampleTest {
    ...
    public static class BookStore extends AbstractModule {
        ...
        public void configure() {
            ...
            newFlow("CatalogService")
                    .listen(Protocol.HTTP, "http://0.0.0.0:8777/services/catalog")
                        .using(CXF.class)
                            .withClass(CatalogService.class)
                    .or().from(Protocol.SERVLET, "servlet://catalog")
