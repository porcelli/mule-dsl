...
public class TestGit {
    ...
    private static final String REMOTE_REPO = "src/test/resources/base-mongo-repo";

    @Before
    public void prepareExternalRepo() {
        try {
            FileUtils.moveDirectory(new File(REMOTE_REPO, "mongo"), new File(REMOTE_REPO, ".mongo"));
        ...
        MuleContext muleContext = Mule.newMuleContext(new AbstractModule() {
            ...
            public void configure() {
                ...
                flow("MyFlow")
                        ...
                        .process(gitConnector.commit("here is!", "porcelli", "porcelli@porcelli.com.br"));
            }
        });
